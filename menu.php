                    ...
                    <div class="recentitems portfolio" style="text-align: center">
                            ...
                            <div class="he-wrap tpl6">
                                ...
                                <div class="he-view">
                                    <div class="bg a0" data-animate="fadeIn">
                                        <h3 class="a1" data-animate="fadeInDown">LOGÍCO - MATEMÁTICO</h3>
                                        ...
                                        <a href="logica_matematica.php" class="dmbutton a2" data-animate="fadeInUp">Jugar</a>
                                    </div><!-- he bg -->
                                </div><!-- he view -->		
                            </div><!-- he wrap -->
                        </div><!-- end col-12 --> 
                        ...
                        <div class="portfolio-item graphic-design">
                            <div class="he-wrap tpl6">
                                ...
                                <div class="he-view">
                                    <div class="bg a0" data-animate="fadeIn">
                                        <h3 class="a1" data-animate="fadeInDown">ABSTRACTO</h3>
                                        ...
                                        <a href="abstracto.php" class="dmbutton a2" data-animate="fadeInUp">Jugar</a>
                                    </div><!-- he bg -->
                                </div><!-- he view -->		
                            </div><!-- he wrap -->
                        </div><!-- end col-12 --> 
                        ...
                        <div class="portfolio-item graphic-design">
                            <div class="he-wrap tpl6">
                                <img src= "assets/img/niveles/medallas.jpg" alt="">
                                <div class="he-view">
                                    <div class="bg a0" data-animate="fadeIn">
                                        <h3 class="a1" data-animate="fadeInDown">MEDALLERÍA</h3>
                                        <a data-rel="prettyPhoto" href="assets/img/niveles//medallas.jpg" class="dmbutton a2" data-animate="fadeInUp">
                                            <i class="fa fa-search"></i></a>
                                        <a href="medalleria.php" class="dmbutton a2" data-animate="fadeInUp">VER MEDALLAS</a>
                                    </div><!-- he bg -->
                                </div><!-- he view -->		
                            </div><!-- he wrap -->
                        </div><!-- end col-12 --> 
