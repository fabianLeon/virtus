...
Juego.Ayuda.prototype = {
	...
	ActualizarFondo: function(buttonName){
		if(buttonName.name=="Continue"){
			...
			this.buttonAceptar = this.game.add.button(300, 450, 'BottonAceptar', this.retornarInicio, this, 1, 0, 2);
			this.buttonAceptar.anchor.setTo(0.5, 0.5);
			this.buttonAtras = this.game.add.button(100, 450, 'BottonAtras', this.ActualizarFondo, this, 1, 0, 2);
