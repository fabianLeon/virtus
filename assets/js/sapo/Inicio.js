...
Juego.Inicio.prototype = {
    preload: function () {
        ...
        this.game.load.image('Fondo', 'assets/img/sapo/fondo1.jpg');
        this.game.load.image('Ayuda_1', 'assets/img/sapo/Ayuda1.png');
        this.game.load.image('Ayuda_2', 'assets/img/sapo/Ayuda2.png');
    ...
    create: function () {
        ...
        this.buttonJugar = this.game.add.button(450, 450, 'Bottones', this.actionOnClick, this, 1, 0, 2);
        this.buttonJugar.anchor.setTo(0.5, 0.5);
        this.buttonJugar.name = 'Jugar';

        this.buttonAyuda = this.game.add.button(750, 450, 'Bottones', this.actionOnClick, this, 4, 3, 5);
        ...
        for (var i = 0; i < 7; i++)
        {
            item = this.game.add.sprite(400 + 70 * i, -100, 'Abecedario', mensaje[i]);
