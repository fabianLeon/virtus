...
Juego.Precarga.prototype = {
    preload: function () {
        ...
        this.game.load.spritesheet('BottonesSonido', 'assets/btn/fichas/BT_Sonido.png', 50, 50, 4);
        this.game.load.spritesheet('BottonPause', 'assets/btn/fichas/BT_Pause.png', 50, 50, 3);
        this.game.load.image('BotonEfecto2', 'assets/btn/fichas/BT_Efectos2.png');
        this.game.load.image('BotonMusica2', 'assets/btn/fichas/BT_Musica2.png');
        this.game.load.spritesheet('BottonReiniciar', 'assets/btn/fichas/BT_Reiniciar.png', 50, 50, 3);
        this.game.load.spritesheet('BottonAyuda', 'assets/btn/fichas/BT_Ayuda.png', 50, 50, 3);
